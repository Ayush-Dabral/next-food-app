  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          {value === "" && (
            <Search className=" text-[#74819E] mr-2 w-4 h-4 shrink-0 opacity-50" />
          )}
          {value
            ? restaurantList.find(
                  ...
                  >
                    <Link href={`/restaurants/${restaurant.id}`} className=" w-full flex">
                      ...
                      <div className=" w-full mx-auto flex flex-col">
                        <h4 className=" w-11/12 mx-auto text-myHeadings font-bold">
                          {restaurant.restaurant_name}
                        </h4>
                        <p className=" w-11/12 mx-auto  text-myDescriptions text-xs">
                          {restaurant.locality}
                        </p>
                      </div>
                    </Link>
